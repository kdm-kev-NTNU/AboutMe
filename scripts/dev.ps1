...
<#
.SYNOPSIS
  Starts Docker infra (PostgreSQL + pgvector), then opens backend and frontend dev servers in new windows.
.DESCRIPTION
  ...
  Only starts db so ports 8080/5173 stay free for local Spring Boot and Vite.
#>
...
try {
    Write-Info "Starting PostgreSQL (pgvector) (docker compose up -d db)..."
