...
Object.assign(doc.components.schemas, {
  ...
  ExperimentResultResponse: {
    ...
    properties: {
      ...
      documentsPreview: { type: 'string' },
      faithfulness: { type: 'number', nullable: true },
      relevance: { type: 'number', nullable: true },
      correctness: { type: 'number', nullable: true },
      conciseness: { type: 'number', nullable: true },
      languageConsistency: { type: 'number', nullable: true },
      faithfulnessExplanation: { type: 'string', nullable: true },
      relevanceExplanation: { type: 'string', nullable: true },
      correctnessExplanation: { type: 'string', nullable: true },
      concisenessExplanation: { type: 'string', nullable: true },
      languageConsistencyExplanation: { type: 'string', nullable: true },
    },
  },
  ExperimentRunDetailResponse: {
    ...
    properties: {
      ...
      name: { type: 'string' },
      datasetName: { type: 'string' },
      evalDatasetId: { type: 'integer', format: 'int64', nullable: true },
      ...
      results: {
        type: 'array',
        items: { $ref: '#/components/schemas/ExperimentResultResponse' },
      },
    },
  },
