    ...
    return [
      {
        ...
        paragraphs: [
          ...
          'Ved å bruke nettstedet godtar du vilkårene som fremgår her, i tillegg til valgene du gjør i samtykkeløsningen for informasjonskapsler.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Valgfri live stemmechat (når den er aktivert) bruker WebRTC slik at lyd kan strømmes mellom nettleseren din og valgt stemmeleverandør, for tiden OpenAI eller ElevenLabs, for sanntidssamtale. Vår server brukes til å starte økten og til grensekontroll (f.eks. hastighetsbegrensning); selve samtalen behandles av leverandøren i tråd med deres vilkår og personvernerklæring.',
      ...
      {
        heading: '5. Teknisk drift og sikkerhet',
        paragraphs: [
      ...
      },
      {
        heading: '7. Endringer',
        paragraphs: [
          'Denne erklæringen kan oppdateres ved endringer på nettstedet eller i lovkrav. «Sist oppdatert»-datoen øverst vil bli justert ved vesentlige endringer.',
        ],
      },
    ]
  }
  return [
    {
      ...
      paragraphs: [
        ...
        'By using the Site you agree to the practices described here, in addition to the choices you make in the cookie consent tool.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Optional live voice chat (when enabled) uses WebRTC so audio can stream between your browser and the selected voice provider, currently OpenAI or ElevenLabs, for a real-time conversation. Our server is used mainly to start the session and enforce limits (such as rate limits); the conversation is processed by the provider according to their terms and privacy policy.',
    ...
    {
      heading: '5. Technical operations and security',
      paragraphs: [
    ...
    },
    {
      heading: '7. Changes',
      paragraphs: [
        'This policy may be updated when the Site or legal requirements change. The «Last updated» date at the top will be revised for material changes.',
      ],
    },
  ]
})
