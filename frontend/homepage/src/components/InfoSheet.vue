  ...
  <div v-if="open" class="overlay" @click.self="toggle">
    <div class="sheet">
      ...
      <div class="social-links">
        <a href="https://github.com/kdm-kev-NTNU" target="_blank" rel="noopener" class="social-link github-link">
          <Github class="social-icon" />
          <span>{{ language === 'en' ? 'GitHub' : 'GitHub' }}</span>
        </a>
        <a href="https://linkedin.com/in/kevin-dennis-mazali/" target="_blank" rel="noopener" class="social-link linkedin-link">
