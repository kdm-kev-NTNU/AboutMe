...
const bannerBody = computed(() =>
  isNo.value
    ? 'Vi bruker PostHog for å forstå hvordan nettsiden brukes. Du kan velge nødvendige, akseptere alle eller avvise valgfri analyse.'
    : 'We use PostHog to understand how the site is used. You can allow necessary only, accept all, or reject optional analytics.',
)
