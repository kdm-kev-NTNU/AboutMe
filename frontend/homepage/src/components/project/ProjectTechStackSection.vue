    ...
    return [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Fangst → kuratér → ingest → verifiser: valgfritt samtaleinnslag (f.eks. stemmeleverandør) er et produktvalg for rikere råmateriale. Det som faktisk indekseres, er ryddede dokumenter via admin-pipelinen. Faglitteratur om RAG handler om indeksering, chunking, retrieval og evaluering, ikke om valg av stemme-UI.',
